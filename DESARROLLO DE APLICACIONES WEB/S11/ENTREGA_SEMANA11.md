...
Para publicar el proyecto en el repositorio, copiar el contenido de esta carpeta en la ruta correspondiente de GitHub y realizar un commit desde la rama indicada por el docente. GitHub Pages debe utilizarse únicamente para mostrar el frontend estático; Flask y Jinja2 deben ejecutarse localmente con `python app.py`.

La página de GitHub Pages no ejecutará las rutas Flask ni procesará plantillas Jinja2. Por ello, la evidencia de variables, bucles, condicionales y componentes debe revisarse en el código del repositorio y mediante la ejecución local.
